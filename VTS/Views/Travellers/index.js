...
const Travellers = (props) => {
  ...
  <View style={{flex : 1}}>
      <View style={{height : hp(13), marginHorizontal : wp(5)}}>
        <Header color={Colors.white} iconColor={Colors.white} heading={'Drivers'} ></Header>
      </View>
                ...
                return <TouchableOpacity onPress={()=>{props.navigation.navigate('travellerDetails')}} style={{height : hp(9),marginVertical : hp(2.7), width : '100%'}}>
                    <View style={{flex : 1, flexDirection : 'row'}}>
                        <View style={{flex : .25}}>
                            <View style={{justifyContent : 'center', alignItems : 'center', height : '100%', width : '100%'}}>
                                <View style={{borderRadius : wp(19)/2, borderWidth : 3, borderColor : 'white', elevation : 14, backgroundColor : Colors.white}}>
                                    <Image source={{uri : 'https://static.thenounproject.com/png/56032-200.png'}}  style={{height : wp(17.5), width : wp(17.5), borderRadius : wp(17.5)/2, borderColor : 'white'}}></Image>
                                    </View>
                            </View>
                        </View>
                        ...
                        <View style={{flex : .75, marginHorizontal  :wp(2)}}>
                            <Text style={{fontSize : Size(2)}}>Malik Sardar, 40</Text>
